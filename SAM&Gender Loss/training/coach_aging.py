...
from datasets.augmentations import AgeTransformer, GenderTransformer
from criteria.lpips.lpips import LPIPS
from criteria.aging_loss import AgingLoss
from criteria.gender_loss import GenderLoss
...
class Coach:
	def __init__(self, opts):
		...
		# Initialize loss
		if self.opts.gender_lambda > 0:
			self.gender_loss = GenderLoss(self.opts)
